...
cuts = 'TMath::Abs(PHI_mass_Cjp - 1.02)<0.01 && PIPI_mass_Cjp > X_mass_Cjp - 3.0969 - 0.15 && BU_mass_Cjp > ' + str(left_discr) + '&& BU_mass_Cjp < ' + str(right_discr)
...
sigma_X.setVal(0.004039); gamma_BW_X.setVal(0.004800)
