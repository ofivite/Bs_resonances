...
if RUN == 2:
    ...
    file_data = ROOT.TFile('./lxplus_dir/X_RunII/X_RunII/BXP_10298_of_20744_B1M1_.root')
elif RUN == 1:
...
if REGIONS_FROM == 'phi':
    ...
    DE_inclus.set_regions(num_of_sigma_window=3, num_of_sigma_to_sdr=2)
...
sData_sig = ROOT.RooStats.SPlot('sData_sig', 'sData_sig', DE_1.data, DE_1.model, sPlot_list)
data_sig_w = ROOT.RooDataSet(DE_1.data.GetName(), DE_1.data.GetTitle(), DE_1.data, data_sig.get(), '1 > 0', N_sig[SPLOT_FROM].GetName() + '_sw')
...
sData_side = ROOT.RooStats.SPlot('sData_side', 'sData_side', DE_3.data, DE_3.model, sPlot_list)
data_side_w = ROOT.RooDataSet(DE_3.data.GetName(), DE_3.data.GetTitle(), DE_3.data, DE_3.data.get(), '1 > 0', N_sig[SPLOT_FROM].GetName() + '_sw')
